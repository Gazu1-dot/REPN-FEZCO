...
export function HomePage() {
 return <ScrollFrame>
  <SystemExplorer/>
  <nav className="scroll-quicknav container" aria-label="Page sections"><span>EXPLORE REPN</span><a href="#applications">Applications <ArrowUpRight size={14}/></a><a href="#project-support">Project support <ArrowUpRight size={14}/></a><a href="#documentation">Documentation <ArrowUpRight size={14}/></a><a href="#start-project">Your project <ArrowUpRight size={14}/></a></nav>
  <section className="scroll-intro container" id="applications" aria-labelledby="application-title">
   ...
   <div className="scroll-applications" data-parallax-region>
    <Link href="/equipment/?application=geothermal" className="scroll-application scroll-application-geo" data-reveal data-tilt><div className="scroll-application-image" data-parallax="65"><AssetImage src="/assets/manufacturing-hero.webp" alt="Illustrative geothermal production field" loading="lazy"/></div><div className="scroll-application-content"><span className="scroll-label">HEAT BELOW THE SURFACE</span><h3>Geothermal.</h3><p>Submersible pumping equipment for geothermal fluid production.</p><span className="scroll-application-link">Explore geothermal <ArrowUpRight size={22}/></span></div></Link>
    <Link href="/equipment/?application=oil-and-gas" className="scroll-application scroll-application-oil" data-reveal data-tilt><div className="scroll-application-image" data-parallax="-45"><AssetImage src="/assets/oil-pump.webp" alt="ESP pump assemblies for oilfield applications" loading="lazy"/></div><div className="scroll-application-content"><span className="scroll-label">EQUIPMENT FOR PRODUCTION</span><h3>Oil &amp; Gas.</h3><p>Modular ESP components selected for oilfield operating conditions.</p><span className="scroll-application-link">Explore oil &amp; gas <ArrowUpRight size={22}/></span></div></Link>
   </div>
  </section>
  <section className="scroll-statement" data-parallax-region aria-labelledby="statement-title"><div className="statement-lines" aria-hidden="true" data-parallax="-60"/><div className="container"><span className="scroll-label">02 / THE SYSTEM PERSPECTIVE</span><h2 id="statement-title" data-reveal>Designed around<br/><span data-parallax="35">what’s below.</span></h2><div className="statement-bottom"><p>Motor. Protector. Pump. Cable.<br/>Connected by your operating conditions.</p><Link href="/equipment/" className="scroll-inline-link">Explore the equipment <ArrowUpRight size={20}/></Link></div></div><span className="statement-outline" aria-hidden="true" data-parallax="90">ESP</span></section>
  <section className="scroll-support container" id="project-support" aria-labelledby="support-title">
   ...
   <div className="scroll-support-grid" data-parallax-region><figure className="scroll-support-photo" data-reveal data-parallax="45"><AssetImage src="/assets/precision-components.jpg" alt="Precision-machined metal components" loading="lazy"/><figcaption>PRECISION COMPONENTS / EQUIPMENT PRODUCTION</figcaption></figure><div className="scroll-support-copy" data-reveal data-parallax="-25"><h2 id="support-title">The equipment.<br/><span>And what comes next.</span></h2><p>Support defined around your equipment and project requirements, from selection and installation to inspection and repair.</p><div className="scroll-service-list"><Link href="/services/"><span>01</span>Selection &amp; project support<ArrowUpRight size={18}/></Link><Link href="/services/"><span>02</span>Installation &amp; field support<ArrowUpRight size={18}/></Link><Link href="/services/"><span>03</span>Inspection &amp; repair<ArrowUpRight size={18}/></Link></div><Link className="scroll-inline-link" href="/company/">Meet REPN-FZCO <ArrowUpRight size={17}/></Link></div></div>
  </section>
  <section className="scroll-resources" id="documentation" data-parallax-region aria-labelledby="scroll-resources-title"><div className="container"><div><span className="scroll-label">04 / TECHNICAL DOCUMENTATION</span><h2 id="scroll-resources-title">The details behind<br/>the selection.</h2></div><div><p>Product guide, pump and motor reference data, and application-specific cable specifications.</p><Link className="scroll-inline-link" href="/resources/">Open downloads <ArrowUpRight size={18}/></Link></div></div></section>
  <section className="scroll-enquiry" data-parallax-region id="start-project" aria-labelledby="scroll-enquiry-title"><div className="container"><div className="scroll-section-meta"><span>05 / YOUR PROJECT</span><span>LET’S START WITH YOUR WELL</span></div><div className="scroll-enquiry-grid" data-reveal><h2 id="scroll-enquiry-title" data-parallax="35">What’s below<br/><span>your surface?</span></h2><div><p>Share your operating conditions.<br/>Let’s define the equipment and support you need.</p><Link className="scroll-button scroll-button-light" href="/contact/">Prepare an enquiry <ArrowUpRight size={20}/></Link><a className="scroll-email" href="mailto:office@repnfzco.com">office@repnfzco.com</a></div></div></div></section>
 </ScrollFrame>;
}
